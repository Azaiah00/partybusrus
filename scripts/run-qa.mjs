...
const jobs=[['technical',['scripts/audit-site.mjs','--output',out+'/local-technical-qa.json']],['markup',['scripts/test-markup.mjs','--output',out+'/markup-qa.json']],['http',['scripts/test-http.mjs']],['quote',['scripts/test-quote.mjs']],['analytics',['scripts/test-analytics.mjs']]];
const results=[];
